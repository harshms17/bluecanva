...
// document.querySelector("#page2>h1").style.color="rgba(231, 231, 231, 0.44)";
// console.log(document.querySelector("#page2>h1").textContent);
...
var clutter2="";
document.querySelector("#page4>h1").textContent.split("").forEach(function(word){
...
var clutter3="";
document.querySelector("#page6>h1").textContent.split("").forEach(function(word){
